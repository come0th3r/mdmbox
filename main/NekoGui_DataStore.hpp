...
namespace NekoGui {
    ...
    public:
        ...
        QString mdmbox_rules_json = "{\"domains\":{\"bypass\":[],\"proxy\":[],\"block\":[]},\"ips\":{\"bypass\":[],\"proxy\":[],\"block\":[]},\"applications\":{\"mode\":\"bypass\",\"items\":[]},\"cidr\":[]}";

        // DNS
        QString remote_dns = "https://dns.google/dns-query";
        QString remote_dns_strategy = "";
        QString direct_dns = "https://dns.google/dns-query";
