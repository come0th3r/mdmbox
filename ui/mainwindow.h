...
public:
    ...
    class QTableWidget *getProxyTable();

    [[nodiscard]] QString shellTrafficText() const;

    [[nodiscard]] int shellLatencyMs() const;
...
private:
    ...
    QVector<int> shell_signal_samples;
    int shell_signal_profile_id = -1;
    bool shell_signal_probe_in_flight = false;
    QTime shell_signal_last_probe_time;
    //
    ...
    void shellRecordSignalSample(int profileId, int latencyMs, bool success);
